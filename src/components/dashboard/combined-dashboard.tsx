    ...
    <section className="space-y-10">
      ...
      <header className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div className="space-y-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-white">{simulatorName}</h1>
        ...
        {chartMode === "non-accumulate" && (
          <>
            ...
            <input
              ...
              min="0"
              step="0.1"
              className="rounded-md border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-slate-100 w-full sm:w-32"
            />
          </>
        )}
      </div>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-800 pb-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-semibold text-white">Simulator Controls</h2>
